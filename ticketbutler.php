...
class TicketButler extends Module {
  ...
  protected function _installSql() {
    $sqlInstall = "ALTER TABLE " . _DB_PREFIX_ . "product " . "ADD tbeventid VARCHAR(255) NULL," . "ADD tbticketid VARCHAR(255) NULL";
    
    $sqlInstallorder = "ALTER TABLE " . _DB_PREFIX_ . "orders " . "ADD tborder TEXT NULL";
  ...
  protected function _unInstallSql() {
    $sqlInstall = "ALTER TABLE " . _DB_PREFIX_ . "product " . "DROP tbeventid, DROP tbticketid";
    $sqlInstallorder = "ALTER TABLE " . _DB_PREFIX_ . "orders " . "DROP tborder";
